...
class DocCompanyIssuer extends Model
{
    protected $table = 'doc_company_issuer';
    ...
    {
        $results = DB::select('EXEC sp_get_doc_company_issuer ?, ?, ?', [$id, $startDate, $endDate]);
        ...
        $renamedResults = array_map(function ($result) {
            return [
                ...
                'Receptor' => $result->document_receiver,
